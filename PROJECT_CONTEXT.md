...
- enhancement / proofreading 需要 Python `>= 3.10`
...
- `~/Library/Application Support/com.minrui.scribby/`
  - `python-env/`
  - `python-standalone/`
  - `swiftwhisper-models/`（Whisper .bin + CoreML .mlmodelc）
...
- AI 校稿模型（Gemma 3 Text 4B）首次使用時自動下載（約 2.6 GB）至 `{AppSupport}/mlx-models/`
